...
somente um domínio específico e isolado, como mobilidade urbana e sistema de
saúde.  Visando solucionar esse problema, algumas pesquisas apontam o uso de
...
devemos realizar testes e experimentos de desempenho.
...
qualidade do software que está sendo desenvolvido. A qualidade de softwares
para cidades tem impacto direto em seu funcionamento e na vida dos cidadãos.
...
que a interação entre elas funciona de maneira correta. Após a completude do
software, com todas as partes integradas, são realizados os testes de sistema.
...
passos para a realização de um teste de desempenho~\cite{bukh_1992}:
...
durante os testes. Com isso é possível realizar a seleção da técnica de
