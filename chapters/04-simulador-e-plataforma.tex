...
alto-nível baseado em núvem para gerenciar recursos \textit{IoT} (Internet das
Coisas) heterogêneos~\cite{arthur_17}.
...
no contexto de Cidades Inteligentes: escalabilidade e
evolutibilidade~\cite{arthur_17}. Escalabilidade é necessário pelo fato da
mesma ter que interagir com um grande número de dispositivos \textit{IoT}
espalhados pela cidade, milhões de usuários e um grande tráfego de dados. Como
as cidades mudam constantemente, a questão da evolutibilidade é essencial, já
...
foram adotadas as seguintes estratégias~\cite{arthur_17}:
...
plataforma InterSCSity. Atualmente, a mesma é composta de 6 microsserviços:
...
vantagem dele é permitir que o \textit{broker} de mensagens faça as decisões de
roteamento, não necessitando a aplicação ter conhecimento desse
processo~\cite{vinoski_2006}.
