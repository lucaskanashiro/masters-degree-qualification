...
crescimento enfrentado por várias cidades gerou congestionamento do tráfego,
poluição e aumento da desigualdade social \cite{kim_2012}. Portanto, Cidades
Inteligentes emergem como um novo paradigma visando atacar esses problemas
usando os recursos da cidade de forma eficiente e prestando serviços de
qualidade para seus cidadãos \cite{arthur_17}.
...
cidade para suportar soluções múltiplas para desafios urbanos
\cite{neirotti_2014}. Atualmente existem várias solução para Cidades
Inteligentes que focam em um domínio específico, como mobilidade urbana e
sistema de saúde. Visando solucionar o problema citado algumas pesquisas
apontam o uso de plataformas de software para Cidades Inteligentes, sendo essas
plataformas um ambiente de \textit{middleware} integrado que oferece suporte a
...
geradas por uma cidade e para garantir isso devemos realizar testes de
software, visando principalmente o desempenho.
...
necessitam da execução do software e as estáticas não. Um exemplo de técnica
estática é a inspeção de software, que é um tipo particular de revisão que
possui um processo de detecção de defeitos rigoroso e bem definido
\cite{fagan_2002}. Por sua vez, o teste de software é uma atividade dinâmica,
onde o seu intuito é executar o programa ou modelo utilizando algumas entradas
em particular e verificar se seu comportamento está de acordo com o esperado
\cite{teste_de_software}. A especificação desse comportamento esperado se dá em
forma de requisitos funcionais e não funcionais do software.
...
possíveis gargalos ainda durante a implementação do software, já que quanto
antes encontrar problemas, menor será o custo para solucioná-los. Segundo
\cite{bukh_1992}, existem alguns passos para a realização de um teste de
desempenho, esses passos são apresentados a seguir.
