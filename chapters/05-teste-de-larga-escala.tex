...
realização de um teste em escala maior. Estamos trabalhando para a realização
desse mesmo teste de desempenho em maior escala (com 467744 vagas e 9329
veículos realizando trajetos de 6h às 9h da manhã em São Paulo). Para isso
estamos automatizando uma implantação mais realista no \textit{Google Cloud
Platform}, utilizando algumas vantagens não exploradas como a escala automática
