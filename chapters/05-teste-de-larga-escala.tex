...
representam o ambiente urbano de maneira realista, demonstrando toda a dinâmica
...
questões de mobilidade, inclusive carros buscando por vagas de estacionamento
...
A integração consistiu na utilização do microsserviço \textit{Resource
...
necessário para que a simulação exerça a carga que aplicações exerceriam
...
com uma carga de pequena escala. Essa hipótese está sendo investigada nos
