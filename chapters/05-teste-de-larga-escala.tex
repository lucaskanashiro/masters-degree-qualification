...
Vale ressaltar que o fluxo apresentado na Figura \ref{fig:atualizacao} é
...
\begin{figure}[ht]
	...
	\caption{Tempo de resposta da plataforma InterSCity}
...
\begin{figure}[ht]
	...
	\caption{Vazão da plataforma InterSCity}
