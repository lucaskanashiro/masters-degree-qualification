...
um domínio específico e isolado, como mobilidade urbana e sistema de saúde.
Visando solucionar esse problema, algumas pesquisas apontam o uso de
plataformas de software para Cidades Inteligentes, sendo essas ambientes de
...
aplicativos~\cite{santana_2016}. Independente do foco da aplicação, a mesma
deve ser capaz de suportar cargas geradas por uma cidade. Para essa garantia
devemos realizar testes e experimentos visando, principalmente, o desempenho.
...
atendendo as necessidades do cliente ou usuário final. Muitas vezes podem haver
problemas no levantamento dos requisitos, e com isso todas as verificações
levarão a crer que o software está sendo desenvolvido corretamente, ao passo
que se a elicitação dos requisitos foi errônea o software desenvolvido não será
o correto, levando o projeto ao fracasso.
