...
As cidades atuais são sistemas complexos que são caracterizados por um grande
...
Visando solucionar esse problema, algumas pesquisas sugerem o uso de
plataformas de software para Cidades Inteligentes, sendo essas ambientes de
middleware integrado que oferecem suporte a desenvolvedores de software no
projeto, implementação, implantação e gerenciamento de
...
funcionais, mais especificamente nos relacionados a desempenho e
escalabilidade.
...
realizados depois dos testes de unidade, e sua ênfase é na construção da
estrutura do sistema. À medida que as partes do software vão ficando prontas, é
necessário garantir que a interação entre elas funcione de maneira correta.
Quando o software é completado, com todas as partes integradas, são realizados
os testes de sistema.  O principal objetivo do teste de sistema é verificar se
os requisitos estão sendo atendidos. Neste trabalho, focaremos nos testes de
sistema, onde o sistema já possui uma versão funcional e testaremos o
desempenho e escalabilidade na escala de uma cidade.
...
passos para a realização de um teste de desempenho adequado~\cite{bukh_1992}:
