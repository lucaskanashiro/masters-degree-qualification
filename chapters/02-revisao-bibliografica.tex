...
Performance é um critério chave no projeto, aquisição, e uso de sistemas
computacionais \cite{bukh_1992}. Alguns critérios de performance, como o tempo
...
isso em vista, especificar e avaliar requisitos de performance em uma aplicação
...
Muitas vezes o processo de teste de performance é feito apenas antes da
...
existem alguns passos para a realização de um teste de performance, esses
...
\begin{enumerate}
	...
	\item Selecionar métricas de performance.
...
alinhados com os requisitos de performance. A seleção das métricas de
performance usualmente seguirá o que foi especificado nos requisitos de
performance, sendo esse um critério de comparação com outros sistemas também,
...
quais parâmetros podem influenciar a performance do sistema, e com isso
...
gargalos no sistema ou simplesmente garantir que os requisitos de performance
...
a realização de testes de performance em larga escala. Portanto, utilizaremos
a técnica de simulação para a avaliação de performance, e a carga será gerada
